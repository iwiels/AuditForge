...
### Chrome DevTools MCP (Active Interception)

- `chrome-devtools_list_network_requests()` - listar requests capturados por tipo
- `chrome-devtools_get_network_request(reqid)` - obtener request/response completo
